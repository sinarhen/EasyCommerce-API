    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BannedStores", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BannedStores_Stores_StoreId",
                        column: x => x.StoreId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Products_Materials_MainMaterialId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductImages", x => new { x.ProductId, x.ColorId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BillboardFilters_ColorId",
                table: "BillboardFilters",
                column: "ColorId");
